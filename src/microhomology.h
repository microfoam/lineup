...
#define MAXROW  20000       /* maximum input line size; not practical if increased; TAGGED: <MAGIC> */
#define WIDTH      72       /* BANDWIDTH: MAX WIDTH OF HEMIDIAGONAL OF PATHBOX; MAX TR UNIT SIZE */
#define MAXHEAD   120       /* MAXIMUM FASTER HEADER LENGTH */
...
void mha_head(int lcl_width)
{
char h1[]=	"\n_MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//"
			  "_MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//"
			  "_MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//__MPGA__//";
